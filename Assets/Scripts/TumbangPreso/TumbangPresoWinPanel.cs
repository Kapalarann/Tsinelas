...
{
    /// <summary>
    /// Self-contained win screen. Attach to your Win Panel prefab and wire up the
    ...
    /// </summary>
    public class TumbangPresoWinPanel : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (_retryButton != null)
                ...
                Debug.LogWarning("TumbangPresoWinPanel: Retry Button is not assigned.");

            if (_hubButton != null)
                _hubButton.onClick.AddListener(OnHubClicked);
            else
                Debug.LogWarning("TumbangPresoWinPanel: Hub Button is not assigned.");
        ...
        private void OnRetryClicked()
        {
            ...
            if (manager != null)
                ...
                Debug.LogWarning("TumbangPresoWinPanel: Could not find TumbangPresoGameManager in scene.");
        }
        ...
        private void OnHubClicked()
        {
            ...
            Debug.Log($"TumbangPresoWinPanel: Back to Hub clicked. Loading '{_hubSceneName}'.");
